      ...
      >
        ...
        <form onSubmit={handleSubmit} className="formModal">
          <label className="formLabel">
            Username:
            <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} className="forminput"/>
          </label>
          <label className="formLabel">
            Password:
            <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="forminput"/>
          </label>
          <button type="submit" className='button__form'>Login</button>
        </form>
      </Modal>
      <ToastContainer />
    </div>
...
const RegisterForm = () => {
  ...
  return (
    <div>
      <button onClick={() => setisRegisterModal(true)}>Register</button>
      <Modal
        isOpen={isRegisterModal}
        onRequestClose={() => setisRegisterModal(false)}
        className="modal"
        overlayClassName="overlay"
      >
        <h2>Register</h2>
